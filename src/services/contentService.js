...
export const contentService = {
  ...
  // ==========================================
  // Website Banners APIs: /content/banners & /admin/banners/*
  // ==========================================
  async getBanners(params = {}) {
    try {
      const res = await api.get("/content/banners", params);
      if (res.success && Array.isArray(res.data)) {
        return res.data;
      }
    } catch (e) {
      console.warn("Failed to fetch website banners from API", e);
    }
    return [];
  },

  async getHeroBanners() {
    return this.getBanners({ section: "home_hero" });
  },
  ...
  async getAdminBanners(params = {}) {
    try {
      ...
      console.warn("Failed to fetch admin banners list from API", e);
    }
    return [];
  },
  ...
  async addBanner(bannerData) {
    ...
    if (!res.success) {
      throw new Error(res.message || "Failed to add banner.");
    }
    return res;
  },
  ...
  async toggleBannerStatus(id, currentStatus) {
    ...
    if (!res.success) {
      throw new Error(res.message || "Failed to toggle banner status.");
    }
